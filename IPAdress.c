#include <stdio.h>
#include <math.h>
#define FILENAME "/home/dimas/BMSTU/2sem_C/IPadress/IP.txt"
...
void write_in_file()
{
    ...
    if (f != NULL)
    {
        while (response == pos_resp)
        {
            ...
            printf("Would you like more IP? y/n: ");
            scanf("\n");
            scanf("%c", &response);
        }
